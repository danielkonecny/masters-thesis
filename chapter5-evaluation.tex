...
\section{\label{sec:evaluation-comparison}Comparison of Self-Supervised and Supervised-Trained Models}
    ...
    \begin{subfigure}[b]{\textwidth}
        ...
        \begin{tikzpicture}
            \begin{axis}[
                ...
                xlabel={Portion of the dataset used for training},
                ylabel={Accuracy on validation dataset},
                xmin=0, xmax=1,
                ymin=0, ymax=1,
